export function LostCompassIcon() {
  return (
    <svg
      xmlnsXlink="http://www.w3.org/1999/xlink"
      className="svg-inline--fa fa-compass-slash fa-4x"
      aria-hidden="true"
      focusable="false"
      data-prefix="fal"
      data-icon="compass-slash"
      role="img"
