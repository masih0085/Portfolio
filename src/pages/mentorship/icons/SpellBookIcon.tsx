export function SpellBookIcon() {
  return (
    <svg
      ...
      className="svg-inline--fa fa-book-spells fa-3x"
      aria-hidden="true"
      focusable="false"
      data-prefix="fal"
      data-icon="book-spells"
      role="img"
