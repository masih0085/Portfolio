export function D12Icon() {
  return (
    <svg
      ...
      className="svg-inline--fa fa-dice-d12 fa-stack-1x has-text-dark"
      aria-hidden="true"
      focusable="false"
      data-prefix="fal"
      data-icon="dice-d12"
