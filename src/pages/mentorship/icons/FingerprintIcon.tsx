export function FingerprintIcon() {
  return (
    <svg
      ...
      className="svg-inline--fa fa-fingerprint fa-stack-1x has-text-dark"
      aria-hidden="true"
      focusable="false"
      data-prefix="fal"
