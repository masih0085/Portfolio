export function D20Icon() {
  return (
    <svg
      ...
      className="svg-inline--fa fa-dice-d20 fa-stack-1x has-text-dark"
      aria-hidden="true"
      focusable="false"
      data-prefix="fal"
      data-icon="dice-d20"
