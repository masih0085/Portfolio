export function DumpsterFireIcon() {
  return (
    <svg
      xmlnsXlink="http://www.w3.org/1999/xlink"
      className="svg-inline--fa fa-dumpster-fire fa-stack-1x has-text-dark"
      aria-hidden="true"
      focusable="false"
      data-prefix="fal"
      data-icon="dumpster-fire"
      role="img"
