export function NetworkChartIcon() {
  return (
    <svg
      xmlnsXlink="http://www.w3.org/1999/xlink"
      className="svg-inline--fa fa-chart-network fa-3x"
      aria-hidden="true"
      focusable="false"
      data-prefix="fal"
