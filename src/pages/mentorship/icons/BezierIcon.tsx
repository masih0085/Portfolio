export function BezierIcon() {
  return (
    <svg
      ...
      className="svg-inline--fa fa-bezier-curve fa-3x"
      aria-hidden="true"
      focusable="false"
      data-prefix="fal"
