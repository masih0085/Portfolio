export function OpenDoorIcon() {
  return (
    <svg
      ...
      className="svg-inline--fa fa-door-open fa-3x"
      aria-hidden="true"
      focusable="false"
      data-prefix="fal"
      data-icon="door-open"
